...
# 360° Adaptation
# -----------------------------------------------------------------------------
_C.MODEL.equirect_mode = "none"  # 'none', 'cm', 'ecm', 'tpp', 'eqc'
# cubemap / extended cubemap face resolution
_C.MODEL.cubemap_face_size = 256
# overlap fraction for extended cubemap (ECM)
_C.MODEL.ecm_overlap = 0.1
# tangent plane projection patch size
_C.MODEL.tpp_patch_size = 256
# tangent plane field of view in degrees
_C.MODEL.tpp_fov_deg = 60.0
# number of latitude bands for tangent point sampling
_C.MODEL.tpp_num_lat = 4
# number of longitude samples per latitude band
_C.MODEL.tpp_num_lon = 8
# whether to replace encoder convolutions with equirectangular convolutions (EQC)
_C.MODEL.eqc_replace_encoder = True
# whether to replace decoder convolutions with equirectangular convolutions (EQC)
_C.MODEL.eqc_replace_decoder = True
