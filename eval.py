...
def evaluate(multilabel_module, cloud_seg_module, loader, cfg, gpu, model_360=None):
    ...
    for batch_data in loader:
        ...
        with torch.no_grad():
            ...
            for img in img_resized_list:
                ...
                if use_360:
                    # 360° adaptation forward pass
                    pred_seg, pred_cloud = model_360(feed_dict, seg_size=seg_size)
                else:
...
def main(cfg, gpu):
    ...
    # Main loop
    evaluate(multilabel_module, cloud_seg_module, loader_val, cfg, gpu, model_360=model_360)
